...
#Routers
import routers.router_students, routers.router_roles ,routers.router_relations , routers.router_users, routers.router_classes, routers.router_auth
...
app.include_router(routers.router_relations.router)
app.include_router(routers.router_roles.router)
