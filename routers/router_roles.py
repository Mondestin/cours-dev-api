...
async def delete_role(role_id:int, cursor:Session=Depends(get_cursor)):
...
async def update_role(role_id: int, payload:schemas_dto.Role_PATCH_Body, cursor:Session=Depends(get_cursor)):
